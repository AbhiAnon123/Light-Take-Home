...
## Description of the Tariff Plan Data
...
{{
    "months": {{
        "January": {{
            "plan": "name of the recommended tariff plan for this month",
            "cost": in cents
        }},
        "February": {{
        ...
        ...
        "tariff_plan_name_1": {{
            "months": {{
                "January": {{
                    ...
                    "breakdown": {{
                        "key": {{
                            "usage": in kWh, how much of the usage falls into this bucket,
                            "cost": in cents, how much cost comes from this bucket based on the usage,
                            "description": Description of the bucket, and what usage qualifies as falling into this bucket
                        }},
                        ...
                    }}
                }},
